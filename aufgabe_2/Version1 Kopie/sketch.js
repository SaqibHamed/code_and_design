...
function draw() {
  ...
  ellipse(posX, height/20+posY, random(5,20));

  // ---- LAYER NR1 B -------------------------------------------

  posY=posY+random(3,20); //Tempo Runter
  ...
  posY=posY+random(1,18); //Tempo Runter
  ...
  ellipse(posX, height/20+posY, random(5,40));

  // ---- LAYER NR2 A -------------------------------------------

  posY2=posY2+random(4,25); //Tempo Runter
  ...
  ellipse(posX2, height/20+posY2, random(5,10));
  ...
  ellipse(posX2, height/20+posY2, random(5,8));

  // ---- LAYER NR2 C -------------------------------------------

  posY2=posY2+random(10,35); //Tempo Runter
  ...
  ellipse(posX2, height/20+posY2, random(2,10));

  // ---- LAYER NR3 A -------------------------------------------

  posY3=posY3+random(5,40); //Tempo runter
  ...
  ellipse(posX3, height/20+posY3, random(5,20));
  ...
  posY3=posY3+random(1,80); //Tempo runter
