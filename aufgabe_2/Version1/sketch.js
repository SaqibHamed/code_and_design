...
function draw() {
  ...
  posY=posY+random(5,70); //Tempo Rechts
  ...
  posY=posY+random(5,90); //Tempo Runter
  ...
  posY=posY+random(40,120); //Tempo Runter
  ...
  posY2=posY2+random(5,70); //Tempo Runter
  ...
  posY2=posY2+random(5,10); //Tempo Runter
  ...
  posY2=posY2+random(2,30); //Tempo Runter
